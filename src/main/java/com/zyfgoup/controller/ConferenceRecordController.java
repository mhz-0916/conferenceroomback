...
//        String name = (String)JSON.parse(depName);
    ...
    public Result searchRecord(
        ...
        LocalDateTime localDateTime = LocalDateTime.parse(searchTime, DATETIME_FORMATTER);
        List<ConRApplyRecord> conRApplyRecords = conferenceRecordService.searchRecord(localDateTime);
        List<Map<String,Object>> list = new ArrayList<>();
        for (ConRApplyRecord conRApplyRecord : conRApplyRecords) {
            Integer roomId = conRApplyRecord.getRoomId();
            String startTime = conRApplyRecord.getStartTime();
            String endTime = conRApplyRecord.getEndTime();
            //String roomBuilding = conRApplyRecord.getRoomBuilding();
            //String roomNo = conRApplyRecord.getRoomNo();
            String roomBuilding = conferenceRoomService.getById(roomId).getRoomBuilding();
            String roomNo = conferenceRoomService.getById(roomId).getRoomNo();
            Employee employee = employeeService.getById(conRApplyRecord.getEId());
            ...
            map.put("roomBuilding",roomBuilding);
